...
return [
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute فقط على أحرف أبجدية أحادية البايت ورموز.',
    ...
    'extensions' => 'يجب أن يكون حقل :attribute لديه إما إمتدادات: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة المعطاة لـ :attribute قد ظهرت في تسريب بيانات. يرجى اختيار :attribute مختلفًا.',
    ],
    ...
    'prohibited_unless' => 'حقل :attribute ممنوع ما لم يكن :other هو :values.',
    ...
    'same' => 'يجب أن يكون حقل :attribute متطابقًا مع :other.',
    'size' => [
    ...
    'unique' => 'تم استخدام قيمة :attribute بالفعل.',
